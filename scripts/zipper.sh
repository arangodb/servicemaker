...
# base image in the virtual environment in /home/user/the_venv and then
# it adds the files in the directory /home/user/project . Finally, it
...
# Now archive everything plus /home/user/project:
